...
import { useAniTypes, useComTypes, useDCTypes, useMarvelTypes, useActionMovies, usepopulerMovies,useScifiMovies, useTrendingMovies, useAdventureMovies } from '../api/api'
function MovieList() {
